	...
	*/
	...
	class STEERLIB_API AStarPlanner{
		public:
			...
			int heap[16];
			int size;
			int getmin(std::map<int, AStarPlannerNode*>& nodeMap);
			void resize();
			int find(int i);
			void add(int i, std::map<int, AStarPlannerNode*>& nodeMap);
			void bubbleup(int i, std::map<int, AStarPlannerNode*>& nodeMap);
			void sinkdown(int i, std::map<int, AStarPlannerNode*>& nodeMap);
			void erase(int i, std::map<int, AStarPlannerNode*>& nodeMap);
		...
		private:
			...
			void expand(int currentNode, int goalIndex, std::set<int> closedset, std::map<int, AStarPlannerNode*>& nodeMap);
	};
